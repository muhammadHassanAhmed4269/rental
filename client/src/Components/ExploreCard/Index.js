    ...
    >
      <div className="relative flex md:flex-row flex-col gap-x-6 bg-white">
        ...
        <div className="md:w-[80%] flex flex-col justify-center">
          <div className="text-xl mb-2 font-semibold tracking-wider">
          ...
          <div className="flex items-center mt-2">
            <p className="font-semibold text-xl pr-12">Zip Code</p>
            ...
            <div>
              ...
              >
                <path
                  ...
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M13.3209 3.6288C11.0331 0.962593 7.21013 0.138618 4.34364 2.58007C1.47714 5.02151 1.07358 9.10346 3.32466 11.991C5.19628 14.3917 10.8604 19.4552 12.7169 21.0941C12.9245 21.2774 13.0284 21.3691 13.1495 21.405C13.2552 21.4364 13.3709 21.4364 13.4767 21.405C13.5978 21.3691 13.7016 21.2774 13.9093 21.0941C15.7657 19.4552 21.4298 14.3917 23.3015 11.991C25.5526 9.10346 25.1982 4.99583 22.2824 2.58007C19.3667 0.164301 15.6087 0.962593 13.3209 3.6288Z"
                  stroke="black"
